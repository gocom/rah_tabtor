...
p. New rules that move navigation items can be created easily directly from rah_tabtor's admin-interface. From the *Tabtor* panel you can find a button labeled as *Create new rule*. Pressing this button will bring up an editor. Present will be the following options.
